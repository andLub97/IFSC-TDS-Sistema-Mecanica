                    ...
                    <div class="tab-content" id="tabdados_material">
                        <div class="tab-pane fade show active" id="dados_material" role="tabpanel" aria-labelledby="dados_material">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="descricao_material" name="descricao_material" maxlength="50" autofocus>
                            </div>
                            <input type="hidden" id="id_material" value="<?php echo isset($id) ? $id : '' ?>" />
                        </div>
                    </div>
                    <br>
                    <div>
