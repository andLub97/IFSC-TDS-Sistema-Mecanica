                ...
                <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="operacao_dados" role="form" action="">
                    ...
                    <div class="tab-content" id="tabdados_operacao">
                        <div class="tab-pane fade show active" id="dados_operacao" role="tabpanel" aria-labelledby="dados_operacao">
                            <div class="col-md-6">
                                <label for="descricao_operacao" class="form-label">Descrição</label>
                                <input type="text" class="form-control" id="descricao_operacao" name="descricao_operacao" maxlength="50" value="<?php echo isset($resultado['descricao']) ? $resultado['descricao'] : ''; ?>" autofocus>
                            </div>
                            <input type="hidden" id="id_operacao" name="id_operacao" value="<?php echo isset($id) ? $id : '' ?>" />
                        </div>
                    </div>
                    <br>
                    <div>
