                    ...
                    <div class="tab-content" id="tabdados_ponto">
                            ...
                            <div class="col-md-6">
                                <label for="eletrodo_ponto" class="form-label">Eletrodo</label><select name="eletrodo_id_ponto" id="eletrodo_id_ponto" class="form-select">
                                    ...
                                    foreach ($eletrodos as $eletrodo) {
                                        if ($eletrodo["id"] == $resultado['eletrodo_id']) {
                                            echo "<option value='" . $eletrodo["id"] . "' selected>" . $eletrodo["descricao"] . "</option>";
                                        } else {
                            ...
                            <div class="col-md-6">
                                <label for="operacao_ponto" class="form-label">Operação</label><select name="operacao_id_ponto" id="operacao_id_ponto" class="form-select">
                                    ...
                                    foreach ($operacoes as $operacao) {
                                        if ($operacao["id"] == $resultado['operacao_id']) {
                                            echo "<option value='" . $operacao["id"] . "' selected>" . $operacao["descricao"] . "</option>";
                                        } else {
                            ...
                            <div class="col-md-6">
                                <label for="eletrodo_ponto" class="form-label">Polaridade</label><select name="polaridade_ponto" id="polaridade_ponto" class="form-select">
                                    ...
                                    if ($resultado["polaridade"] == 0) {
                                        echo "<option value='0' selected>Negativa</option>";
                                        echo "<option value='1'>Positiva</option>";
                                    } else {
                                        echo "<option value='0'>Negativa</option>";
                                        echo "<option value='1' selected>Positiva</option>";
                                    }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="tab-pane fade" id="complemento_ponto" role="tabpanel" aria-labelledby="complemento_ponto">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="valor_corrente_ponto" name="valor_corrente_ponto" maxlength="100" value="<?php echo isset($resultado['valor_corrente']) ? str_replace(".", ",", $resultado["valor_corrente"]) : ''; ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="valor_desgaste_ponto" class="form-label">Valor Desgaste</label>
                                <input type="text" class="form-control" id="valor_desgaste_ponto" name="valor_desgaste_ponto" maxlength="100" value="<?php echo isset($resultado['valor_desgaste']) ?  str_replace(".", ",", $resultado["valor_desgaste"]) : ''; ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="valor_remocao_ponto" class="form-label">Valor Remoção</label>
                                <input type="text" class="form-control" id="valor_remocao_ponto" name="valor_remocao_ponto" maxlength="100" value="<?php echo isset($resultado['valor_remocao']) ?  str_replace(".", ",", $resultado["valor_remocao"]) : ''; ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="valor_rugosidade_ponto" class="form-label">Valor Rugosidade</label>
                                <input type="text" class="form-control" id="valor_rugosidade_ponto" name="valor_rugosidade_ponto" maxlength="100" value="<?php echo isset($resultado['valor_rugosidade']) ?  str_replace(".", ",", $resultado["valor_rugosidade"]) : ''; ?>">
                            </div>
