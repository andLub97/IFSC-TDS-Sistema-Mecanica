                    ...
                    <div class="tab-content" id="tabdados_eletrodo">
                        <div class="tab-pane fade show active" id="dados_eletrodo" role="tabpanel" aria-labelledby="dados_eletrodo">
                            <div class="col-md-6">
                                <label for="material_id_eletrodo" class="form-label">Material</label><select name="material_id_eletrodo" id="material_id_eletrodo" class="form-select">
                                    ...
                                    foreach ($materiais as $material) {
                                        if ($material["id"] == $resultado['material_id']) {
                                            echo "<option value='" . $material["id"] . "' selected>" . $material["descricao"] . "</option>";
                                        } else {
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="descricao_eletrodo" name="descricao_eletrodo" maxlength="100" value="<?php echo isset($resultado['descricao']) ? $resultado['descricao'] : ''; ?>" autofocus>
                            </div>
                        </div>
                        <input type="hidden" id="id_eletrodo" name="id_eletrodo" value="<?php echo isset($id) ? $id : '' ?>" />
                    </div>
            </div>
            <br>
            <div>
